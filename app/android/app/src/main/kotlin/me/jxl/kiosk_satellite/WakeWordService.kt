...
class WakeWordService : Service() {
    ...
    // while the admin server hums along underneath. The gates and the relaunch
    // live in CrashSelfHeal, shared with the hooks that cover kiosks where
    // this service never runs at all (background listening off, the default).

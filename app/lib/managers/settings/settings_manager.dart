        ...
        Command(
          ...
          handler: (p) async {
            ...
            if (!adoptIdentity) {
              ...
              // The Sendspin player id is an identity too: two devices
              // connecting to Music Assistant under one id kick each other
              // off in a reconnect loop, and neither ever syncs (issue
              // #136). Dropped here for the same reason, regenerated by
              // the Sendspin manager on its next start.

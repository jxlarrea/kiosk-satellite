...
| `.../screensaver/…`, `.../kiosk/…`, `.../ha_kiosk/…`, `.../keep_screen_on/…`, `.../remote/…`, `.../screensaver_brightness/…`, `.../hold_mode/…`, `.../camera_enabled/…`, `.../screensaver_motion/…`, `.../screensaver_face/…` | out / in | `ON` / `OFF` (`state` and `set` each) |

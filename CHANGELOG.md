...
- **Plugin release checks and layout.** Repository installs require GitHub Actions asset publication and a matching GitHub SHA-256 digest. Local ZIPs are labeled for developers only. Action guidance now follows the Actions group.
